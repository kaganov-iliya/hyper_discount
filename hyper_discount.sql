...
MySQL - 5.5.41-0+wheezy1 : Database - discount
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`discount` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `oc_api`(`api_id`,`name`,`key`,`status`,`date_added`,`date_modified`) values ('1','Default','','1','2016-07-28 20:40:41','2016-07-28 20:40:41');
...
insert  into `oc_attribute_group_description`(`attribute_group_id`,`language_id`,`name`) values ('3','1','Память'),('4','1','Technical'),('5','1','Материнская плата'),('6','1','Процессор'),('3','2','Memory'),('4','2','Technical'),('5','2','Motherboard'),('6','2','Processor');
...
insert  into `oc_banner`(`banner_id`,`name`,`status`) values ('6','Продукция HP','1'),('7','Слайдшоу на главной','1'),('8','Производители','1');
...
insert  into `oc_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values ('1','Рубль','RUB','',' р.','2','1.00000000','1','2016-07-28 17:41:36'),('2','US Dollar','USD','$','','2','0.01490000','1','2016-07-28 17:40:54'),('3','Euro','EUR','','€','2','0.01350000','1','2016-07-28 17:40:54');
...
insert  into `oc_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values ('1','Russian','ru','ru_RU.UTF-8,ru_RU,russian','ru.png','russian','1','1'),('2','English','en','en_US.UTF-8,en_US,en-gb,english','gb.png','english','2','1');
...
insert  into `oc_layout`(`layout_id`,`name`) values ('1','Главная'),('2','Продукт'),('3','Категория'),('4','По умолчанию'),('5','Производитель'),('6','Аккаунт'),('7','Оформление заказ'),('8','Контакты'),('9','Карта сайта'),('10','Партнерская программа'),('11','Информация'),('12','Сравнение'),('13','Поиск');
...
insert  into `oc_length_class`(`length_class_id`,`value`) values ('1','1.00'),('2','10.00'),('3','0.39');
...
insert  into `oc_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values ('1','1','Сантиметр','см'),('2','1','Миллиметр','мм'),('1','2','Centimeter','cm'),('2','2','Millimeter','mm');
...
insert  into `oc_order_status`(`order_status_id`,`language_id`,`name`) values ('1','1','Ожидание'),('2','1','В обработке'),('3','1','Доставлено'),('7','1','Отменено'),('5','1','Сделка завершена'),('8','1','Возврат'),('9','1','Отмена и аннулирование'),('10','1','Неудавшийся'),('11','1','Возмещенный'),('12','1','Полностью измененный'),('13','1','Полный возврат'),('1','2','Pending'),('2','2','Processing'),('3','2','Shipped'),('7','2','Canceled'),('5','2','Complete'),('8','2','Denied'),('9','2','Canceled Reversal'),('10','2','Failed'),('11','2','Refunded'),('12','2','Reversed'),('13','2','Chargeback');
...
insert  into `oc_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values ('43','2','1','1'),('47','2','1','4'),('43','4','1','8гб'),('42','3','1','100мгц'),('47','4','1','16ГБ'),('43','2','2','1'),('47','2','2','4'),('43','4','2','8gb'),('42','3','2','100mhz'),('47','4','2','16GB');
...
insert  into `oc_product_to_category`(`product_id`,`category_id`,`main_category`) values ('28','20','0'),('28','24','0'),('29','20','0'),('29','24','0'),('30','20','0'),('30','33','0'),('31','33','0'),('32','34','0'),('33','20','0'),('33','28','0'),('34','34','0'),('35','20','0'),('36','34','0'),('40','20','0'),('40','24','0'),('41','27','0'),('42','20','0'),('42','28','0'),('43','18','0'),('43','20','0'),('44','18','0'),('44','20','0'),('45','18','0'),('46','18','0'),('46','20','0'),('47','18','0'),('47','20','0'),('48','20','0'),('48','34','0'),('49','57','0');
...
insert  into `oc_return_action`(`return_action_id`,`language_id`,`name`) values ('1','1','Возвращены средства'),('2','1','Выдан в кредит'),('3','1','Отправлена замена (отправлен другой товар для замены)'),('1','2','Refunded'),('2','2','Credit Issued'),('3','2','Replacement Sent');
...
insert  into `oc_return_reason`(`return_reason_id`,`language_id`,`name`) values ('1','1','Получен/доставлен неисправным (сломанным)'),('2','1','Получен не тот (ошибочный) товар'),('4','1','Ошибочный, пожалуйста, укажите/приложите подробности'),('5','1','Другое (другая причина), пожалуйста, укажите/приложите подробности'),('1','2','Dead On Arrival'),('2','2','Received Wrong Item'),('4','2','Faulty, please supply details'),('5','2','Other, please supply details');
...
insert  into `oc_return_status`(`return_status_id`,`language_id`,`name`) values ('1','1','Рассматриваемый / находящийся в '),('3','1','Готов (к отправке) / или Заверше'),('2','1','Заказ \"висит\" в ожидании поступл'),('1','2','Pending'),('3','2','Complete'),('2','2','Awaiting Products');
...
insert  into `oc_stock_status`(`stock_status_id`,`language_id`,`name`) values ('7','1','В наличии'),('8','1','Предзаказ'),('5','1','Нет в наличии'),('6','1','Ожидание 2-3 дня'),('7','2','In Stock'),('8','2','Pre-Order'),('5','2','Out Of Stock'),('6','2','2 - 3 Days');
...
insert  into `oc_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values ('9','Налоги','Облагаемые налогом','2009-01-06 23:21:53','2011-03-09 21:17:10'),('10','Цифровые товары','Цифровые','2011-09-21 22:19:39','2011-09-22 10:27:36');
...
insert  into `oc_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values ('86','3','НДС (20%)','20.0000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),('87','3','Экологический налог (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');
...
insert  into `oc_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values ('1','1','discount','404e493cde63f64da8ec664d919b2e5804c93149','yJTvov3KL','John','Doe','admin@awaro.ru','','','136.243.60.7','1','2016-07-28 20:40:41');
...
insert  into `oc_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values ('6','1','Рождество'),('7','1','День рождения'),('8','1','Основной'),('6','2','Christmas'),('7','2','Birthday'),('8','2','General');
...
insert  into `oc_weight_class`(`weight_class_id`,`value`) values ('1','1.00'),('2','1000.00'),('5','2.20'),('6','35.27');
...
insert  into `oc_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values ('1','1','Килограммы','кг'),('2','1','Граммы','г'),('1','2','Kilogram','kg'),('2','2','Gram','g');
